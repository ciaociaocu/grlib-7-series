...
project.setVariantName('xc7k325t-ffg900-2')
...
project.addFile('gaisler','../../lib/gaisler/canfd/canfd.vhd')
...
project.addFile('gaisler','../../lib/gaisler/nand/nandpkg.vhd')
...
project.addFile('gaisler','../../lib/gaisler/leon5v0/l5stat.vhd')
...
project.addFile('work','../../boards/digilent-genesys2/ahb2mig_arty_a7.vhdl')
project.addFile('work','../../boards/digilent-genesys2/clockers_mig.vhdl')
project.addFile('work','../../boards/digilent-genesys2/clockers_clkgen.vhdl')
...
# Read pin map
if os.path.exists(os.path.join(workdir, 'leon3mp_pads.py')):
